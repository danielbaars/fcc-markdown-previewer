...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _markdown_input = __webpack_require__(200);

	var _markdown_input2 = _interopRequireDefault(_markdown_input);

	var _markdown_output = __webpack_require__(202);

	var _markdown_output2 = _interopRequireDefault(_markdown_output);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_markdown_input2.default, null),
	        _react2.default.createElement(_markdown_output2.default, null)
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MarkdownInput = function (_Component) {
	  _inherits(MarkdownInput, _Component);

	  function MarkdownInput() {
	    _classCallCheck(this, MarkdownInput);

	    return _possibleConstructorReturn(this, (MarkdownInput.__proto__ || Object.getPrototypeOf(MarkdownInput)).apply(this, arguments));
	  }
	  ...
	  _createClass(MarkdownInput, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { style: inputStyling, className: 'col-md-6' },
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ setInput: _actions.setInput }, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(MarkdownInput);
...
/***/ (function(module, exports) {
	...
	var SET_INPUT = exports.SET_INPUT = 'SET_INPUT';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _marked = __webpack_require__(203);
	...
	var MarkdownOutput = function (_Component) {
	  _inherits(MarkdownOutput, _Component);

	  function MarkdownOutput() {
	    _classCallCheck(this, MarkdownOutput);

	    return _possibleConstructorReturn(this, (MarkdownOutput.__proto__ || Object.getPrototypeOf(MarkdownOutput)).apply(this, arguments));
	  }

	  _createClass(MarkdownOutput, [{
	    key: 'convertMarkdown',
	    value: function convertMarkdown() {
	      return {
	        __html: (0, _marked2.default)(this.props.input)
	      };
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('div', { dangerouslySetInnerHTML: this.convertMarkdown() })
	      );
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(MarkdownOutput);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reducer_input = __webpack_require__(205);

	var _reducer_input2 = _interopRequireDefault(_reducer_input);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  input: _reducer_input2.default
	});
